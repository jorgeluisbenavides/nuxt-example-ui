...
function isFragment(node) {
    ...
    return patchFlag === shared_1.PatchFlags.KEYED_FRAGMENT
        || patchFlag === shared_1.PatchFlags.UNKEYED_FRAGMENT
        || patchFlag === shared_1.PatchFlags.STABLE_FRAGMENT
        || patchFlag === shared_1.PatchFlags.BAIL;
}
...
function pullConfigComponents(children, nodes, ownerConfig) {
    children.forEach((node) => {
        ...
        const componentChildren = (0, vue_helper_1.configurationChildren)(node);
        const initialValues = {
            ...componentInfo.$_predefinedProps,
            ...(0, vue_helper_1.getNormalizedProps)(node.props || {}),
        };
