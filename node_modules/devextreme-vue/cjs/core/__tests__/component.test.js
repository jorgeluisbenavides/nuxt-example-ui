...
function createComponent(config) {
    (0, index_1.prepareComponentConfig)(config);
    return (0, vue_1.defineComponent)(config);
}
function createConfigurationComponent(config) {
    (0, index_1.prepareConfigurationComponentConfig)(config);
    return (0, vue_1.defineComponent)(config);
}
function createExtensionComponent(config) {
    (0, index_1.prepareExtensionComponentConfig)(config);
    return (0, vue_1.defineComponent)(config);
}
const eventHandlers = {};
const Widget = {
...
describe('component rendering', () => {
    ...
    describe('correctly forwards classes', () => {
        it('forwards correct attrs in the render method', async () => {
            const component = (0, vue_1.defineComponent)({
                ...
                setup() {
                    const isDisabled = (0, vue_1.ref)(false);
    ...
    it('correctly sets the help link', () => {
        expect((0, config_1.default)().licensingDocLink).toBe('https://go.devexpress.com/Licensing_Documentation_DevExtremeVue.aspx');
    });
    describe('options', () => {
...
describe('children processing', () => {
    it.skip('should process children if they are wrapped to a bail container', () => {
        ...
        expect(vnode.patchFlag).toBe(shared_1.PatchFlags.BAIL);
