...
import { TextEditorButton, LabelMode, EditorStyle, ValidationMessageMode, Position, ValidationStatus, HorizontalAlignment, VerticalAlignment, TextEditorButtonLocation, PositionAlignment, Direction, ButtonStyle, ToolbarItemLocation, ToolbarItemComponent } from "devextreme/common";
...
type AccessibleOptions = Pick<Properties, "acceptCustomValue" | "accessKey" | "activeStateEnabled" | "buttons" | "contentTemplate" | "dataSource" | "deferRendering" | "disabled" | "displayExpr" | "displayValueFormatter" | "dropDownButtonTemplate" | "dropDownOptions" | "elementAttr" | "fieldTemplate" | "focusStateEnabled" | "height" | "hint" | "hoverStateEnabled" | "inputAttr" | "isDirty" | "isValid" | "items" | "label" | "labelMode" | "maxLength" | "name" | "onChange" | "onClosed" | "onCopy" | "onCut" | "onDisposing" | "onEnterKey" | "onFocusIn" | "onFocusOut" | "onInitialized" | "onInput" | "onKeyDown" | "onKeyUp" | "onOpened" | "onOptionChanged" | "onPaste" | "onValueChanged" | "opened" | "openOnFieldClick" | "placeholder" | "readOnly" | "rtlEnabled" | "showClearButton" | "showDropDownButton" | "stylingMode" | "tabIndex" | "text" | "validationError" | "validationErrors" | "validationMessageMode" | "validationMessagePosition" | "validationStatus" | "value" | "valueChangeEvent" | "valueExpr" | "visible" | "width">;
interface DxDropDownBox extends AccessibleOptions {
    readonly instance?: DropDownBox;
}
declare const DxDropDownBox: import("@vue/runtime-core").DefineComponent<{
    ...
    displayValueFormatter: PropType<(value: string | Array<any>) => string>;
    ...
    "onUpdate:displayValueFormatter"?: ((...args: any[]) => any) | undefined;
}, {
