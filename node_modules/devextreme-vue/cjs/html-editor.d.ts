...
import { Converter, dxHtmlEditorImageUpload, dxHtmlEditorMediaResizing, dxHtmlEditorMention, ContentReadyEvent, DisposingEvent, FocusInEvent, FocusOutEvent, InitializedEvent, OptionChangedEvent, ValueChangedEvent, dxHtmlEditorTableContextMenu, dxHtmlEditorTableResizing, dxHtmlEditorToolbar, dxHtmlEditorVariables, AICommandName, HtmlEditorImageUploadMode, dxHtmlEditorImageUploadTabItem, HtmlEditorImageUploadTab, dxHtmlEditorTableContextMenuItem, HtmlEditorPredefinedContextMenuItem, HtmlEditorPredefinedToolbarItem, AICommand, AIToolbarItem, dxHtmlEditorToolbarItem } from "devextreme/ui/html_editor";
...
declare const DxCommand: import("@vue/runtime-core").DefineComponent<{
    name: PropType<"custom" | "expand" | "summarize" | "proofread" | "shorten" | "changeStyle" | "changeTone" | "translate" | "askAI">;
    options: {};
    prompt: PropType<(param: string) => string>;
...
declare const DxItem: import("@vue/runtime-core").DefineComponent<{
    ...
    commands: PropType<(AICommandName | AICommand)[]>;
...
declare const DxToolbar: import("@vue/runtime-core").DefineComponent<{
    container: {};
    items: PropType<(HtmlEditorPredefinedToolbarItem | AIToolbarItem | dxHtmlEditorToolbarItem)[]>;
