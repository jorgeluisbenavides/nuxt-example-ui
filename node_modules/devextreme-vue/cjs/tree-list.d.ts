...
declare const DxEditing: import("@vue/runtime-core").DefineComponent<{
    allowAdding: PropType<boolean | ((options: {
        component: dxTreeList;
        row: dxTreeListRowObject;
    }) => boolean)>;
...
declare const DxEditingTexts: import("@vue/runtime-core").DefineComponent<{
    ...
    addRowToNode: StringConstructor;
    ...
    "onUpdate:addRowToNode"?: ((...args: any[]) => any) | undefined;
}, {}>;
...
declare const DxToolbar: import("@vue/runtime-core").DefineComponent<{
    disabled: BooleanConstructor;
    items: PropType<(TreeListPredefinedToolbarItem | import("devextreme/artifacts/npm/devextreme/ui/tree_list").ToolbarItem)[]>;
    visible: BooleanConstructor;
}, unknown, unknown, {}, {}, import("@vue/runtime-core").ComponentOptionsMixin, import("@vue/runtime-core").ComponentOptionsMixin, {
    "update:isActive": null;
    "update:hoveredElement": null;
...
declare const DxTreeListHeaderFilter: import("@vue/runtime-core").DefineComponent<{
    allowSearch: BooleanConstructor;
    allowSelectAll: BooleanConstructor;
    height: (NumberConstructor | StringConstructor)[];
...
declare const DxTreeListHeaderFilterSearch: import("@vue/runtime-core").DefineComponent<{
    editorOptions: {};
    enabled: BooleanConstructor;
    mode: PropType<SearchMode>;
    timeout: NumberConstructor;
...
declare const DxTreeListHeaderFilterTexts: import("@vue/runtime-core").DefineComponent<{
    cancel: StringConstructor;
    emptyValue: StringConstructor;
    ok: StringConstructor;
}, unknown, unknown, {}, {}, import("@vue/runtime-core").ComponentOptionsMixin, import("@vue/runtime-core").ComponentOptionsMixin, {
...
declare const DxTreeListSelection: import("@vue/runtime-core").DefineComponent<{
    allowSelectAll: BooleanConstructor;
    mode: PropType<SingleMultipleOrNone>;
    recursive: BooleanConstructor;
}, unknown, unknown, {}, {}, import("@vue/runtime-core").ComponentOptionsMixin, import("@vue/runtime-core").ComponentOptionsMixin, {
...
export { DxTreeList, DxAnimation, DxAsyncRule, DxAt, DxBoundaryOffset, DxButton, DxChange, DxColCountByScreen, DxCollision, DxColumn, DxColumnChooser, DxColumnChooserSearch, DxColumnChooserSelection, DxColumnFixing, DxColumnFixingTexts, DxColumnHeaderFilter, DxColumnHeaderFilterSearch, DxColumnLookup, DxCompareRule, DxCursorOffset, DxCustomOperation, DxCustomRule, DxEditing, DxEditingTexts, DxEmailRule, DxField, DxFieldLookup, DxFilterBuilder, DxFilterBuilderPopup, DxFilterOperationDescriptions, DxFilterPanel, DxFilterPanelTexts, DxFilterRow, DxForm, DxFormat, DxFormItem, DxFrom, DxGroupOperationDescriptions, DxHeaderFilter, DxHide, DxIcons, DxItem, DxKeyboardNavigation, DxLabel, DxLoadPanel, DxLookup, DxMy, DxNumericRule, DxOffset, DxOperationDescriptions, DxPager, DxPaging, DxPatternRule, DxPopup, DxPosition, DxRangeRule, DxRemoteOperations, DxRequiredRule, DxRowDragging, DxScrolling, DxSearch, DxSearchPanel, DxSelection, DxShow, DxSorting, DxStateStoring, DxStringLengthRule, DxTexts, DxTo, DxToolbar, DxToolbarItem, DxTreeListHeaderFilter, DxTreeListHeaderFilterSearch, DxTreeListHeaderFilterTexts, DxTreeListSelection, DxValidationRule };
